...
##Published in Frontiers In Plant Science 2019
##Poster Presentation for IS-MPMI XVIII Congress in Glasgow Scotland, 2019
...
#Bin Severity rating to three categories: Mild, Moderate, Severe
...
#Change severity columns to factors and reorder levels
...
#Stats on Count of Bacteria: Xylella, Stenotrophomonas and Pseudoxanthomonas
```{r}
...
#Alpha Diversity: Based On Observed Number Of Taxa
...
#Poisson GLM for count data statistics : Bacteria
...
#Poisson GLM for count data statistics : Fungal
...
#Create Auxillary Lollipop graphs for Upset
...
#Beta Diberity: Weighted Unifrac PCoA (Bac) , Bray-Curtis NMDS (Fun)
